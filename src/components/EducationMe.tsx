...
import me from "../assets/img/eduOrange.svg";
import { educationmedata } from "../assets/lib/data";
...
const EducationMe: React.FC = () => {
  ...
  const paragraphs =
    language === "DE" ? educationmedata.paragraphs_EN : educationmedata.paragraphs_EN;
        ...
        <div className="title-container flex flex-col gap-6 justify-center items-center p-32 w-1/2 max-lg:w-full max-lg:p-16 max-lg:items-start">
          ...
          >
            <p className="text-[--black] mb-6">
              ...
              {language === "DE" ? educationmedata.title_EN : educationmedata.title_EN}
              <span className="text-orange">/&gt;</span>
            </p>

            <h2 className="text-[--black] text-center max-lg:text-left break-words">
              {language === "DE"
                ? educationmedata.description_EN
                : educationmedata.description_EN}
            </h2>
          </motion.div>
        </div>
